...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        {
            var celectialObjects = _context.CelestialObjects.Where(e => e.Id == id || e.OrbitedObjectId == id);

            if (!celectialObjects.Any())
            {
                return NotFound();
            }

            _context.CelestialObjects.RemoveRange(celectialObjects);
            _context.SaveChanges();
